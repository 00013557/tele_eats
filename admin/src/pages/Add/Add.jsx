        ...
        <div className="add-category-price">
            <div className="add-category flex-col">
                ...
                <select onChange={onChangeHandler} name="category">
                    ...
                    <option value="Oqtepa">Oqtepa Lavash</option>
                    <option value="BON!">BON!</option>
                    <option value="Giotto">Giotto</option>
                    <option value="Les Ailes">Les Ailes</option>
                    <option value="Domino's Pizza">Domino's Pizza</option>
                    <option value="Yaponamama">Yaponamama</option>
                </select>
            </div>
            <div className="add-price flex-col">
                <p>Product Price</p>
                <input onChange={onChangeHandler} value={data.price}type="Number" name='price' placeholder='10000 soums' />
            </div>
        </div>
